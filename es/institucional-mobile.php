...
<section id="content">
  <div class="container">
    ...
    <div class="row font-12">
      ...
      <!-- row 1 -->
      <div class="span12">
        <h2>Escolha o tipo de aplicativo para o seu negócio!</h2>
        <p>
          Podemos criar os mais diversos tipos de aplicativos para o seu negócio, abaixo alguns exemplos do que podemos criar.:
        </p>
        <div id="aplicativos">
