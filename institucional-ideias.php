...
<section id="content">
  <div class="container">
      ...
      <div class="span12">
        <div class=" page-effect-wrapper">
          ...
          <div class="page-header1">
            <h2>MATERIALIZANDO IDEIAS<small> Desenvolva sua ideia conosco!</small></h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row font-12">
        ...
        <div class="post-border-right">
          <article class="post-holder">
            ...
            <p>
              ...
              <h2>Boas ideias materializadas se tornam negócios</h2>
              ...
              <br>
              Com esse crescimento exponencial da área de mobile (smartphones, tablets) muitas pessoas estão entrando para este mercado com aplicativos, sites, serviços e ideias. Ideias? Sim, a maior parte dos aplicativos para dispositivos moveis tem o objetivo de suprir uma necessidade, seja diversão, lazer, profissional ou solucionar um problema qualquer. 
              A maioria das boas ideias e dos grandes negócios surgem como solução para um problema que o empreendedor já viveu e muitas pessoas tem boas ideias a partir de vivências próprias para resolver necessidades do dia a dia. Faz sentido, quando passamos por algum apuro podemos pensar com propriedade formas criativas e inovadoras de resolver a questão, a diferença é que essas ideias não necessariamente são colocadas em prática.
            </p>
            <p class="p0">
              Então porque não criar sua ideia? Nós da in6 Mobile desenvolvemos aplicativos para dispositivos móveis com bastante profissionalismo, dedicação e uma boa dose de criatividade. Além de criar as nossas próprias ideias também podemos criar a sua. Entre em contato e faça um orçamento conosco. Ficaremos contentes em atendê-lo.
            </p>
      ...
      <!-- row 1 -->
      <div class="span12">
        <h2>Afinal, o que pode ser uma boa ideia?</h2>
        <p>
